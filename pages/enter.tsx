    ...
    <div className="mt-16 px-4 ">
      ...
      <div className="mt-8">
        <div className="flex flex-col items-center">
          ...
          <div className="grid grid-cols-2 w-full gap-16 mt-8">
            <button
              className={cls(
        ...
        <div className='relative'>          
          ...
          <div className='grid grid-cols-2 gap-3 mt-2'>
            <button className='flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm font-medium text-gray-400 hover:bg-gray-50'>
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
